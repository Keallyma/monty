...
/**is_delimn - check if stream has deliminator char
 *
 ...
 * @str: string to get word length from cur word
 * @delims: delimitors to use to delimit words
 *
 * return: word length of curr word 
 */
...
/**
 * get_word_count - get the word count of a string
...
/**
 * get_next_word - get the next word in a string
 * @str: string to get next word from
 * @delims: delimitots to use to delimit words 
 *
