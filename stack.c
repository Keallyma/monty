...
/**
 * init_stack - intializes a stack_t stack with beginning stack and ending queue nodes.
 ...
 *
 * Return: If the stack_t is in stack mode - STACK (0), if the stack id in queue mode - QUEUE (1) otherwise (2).
 */
int check_mode(stack_t *stack)
{
	if (stack->n == STACK)
